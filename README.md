...
3. Rename the following from _FunkyUI_ to your new mod name:
    * Folder the project is in
    * **.csproj** file
    * **.sln** file
4. Open the **.sln** file with a text editor, CTRL+F for _FunkyUI_ and replace it with your new mod name
5. Open the **.csproj** file with a text editor, CTRL+F for _FunkyUI_ and replace it with your new mod name
